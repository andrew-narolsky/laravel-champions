...
class Club extends Model
{
    ...
    private const string NAME_PREFIX_REGEX = '/^(III.\|1\. FC|AC|AF|AE|AJ|AK|AS|ASKÖ|BFC|CA|CE|CO|ČFK|DSV|ÉF|EF|FC|FCI|FF|FK|GNK|HNK|HŠK|ÍF|IFK|JK|JS|K|KAA|KF|KRC|KS|KSC|KSK|KSV|KV|KVC|LB|Le|NK|OFC|OGC|PFC|PFK|POFC|R|RAA|RC|RCS|RNK|RSC|RFC|RE|RRC|RWD|SC|SFC|SFK|SK|SKN|SpC|SpVgg|SpVg|SV|TSV|TSG|VfB|VfR|UE|US)\s+/i';
