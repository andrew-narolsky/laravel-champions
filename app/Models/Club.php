...
class Club extends Model
{
    ...
    private const string NAME_PREFIX_REGEX = '/^(III.\|1\. FC|AC|ACF|AF|AFK|AE|AJ|AK|AS|ASKÖ|BFC|CA|CE|CO|CS|ČFK|DSV|ÉF|EF|EFC|FBC|FC|FCI|FF|FK|GFK|GNK|HNK|HŠK|ÍF|IFK|IK|JFK|JK|JS|K|KAA|KF|KRC|KS|KSC|KSK|KSV|KV|KVC|LB|Le|LR|NK|OFC|OGC|PFC|PFK|POFC|R|RAA|RC|RCS|RNK|RSC|RFC|RE|RRC|RWD|SBV|SC|SFC|SFK|SK|SKN|SpC|SpVgg|SpVg|SS|SSC|SSD|SV|TSV|TSG|VfB|VfR|UC|UE|US|USD|USV)\s+/i';
