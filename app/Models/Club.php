...
class Club extends Model
{
    ...
    {
        return preg_replace('/^(1.|AC|AF|AK|ASKÖ|CE|DSV|FC|FK|K|KAA|KF|KRC|KS|KSC|KSK|KSV|KV|KVC|PFK|R|RAA|RCS|RSC|RFC|RE|RRC|RWD|SC|SK|SKN|SV|SpC|TSV|UE)\s+/i', '', $this->name);
    }
