...
class Club extends Model
{
    ...
    {
        return preg_replace('/^(1.|AC|AF|AK|ASKÖ|CE|ČFK|DSV|FC|FK|GNK|HNK|HŠK|K|KAA|KF|KRC|KS|KSC|KSK|KSV|KV|KVC|NK|OFC|PFC|PFK|POFC|R|RAA|RCS|RNK|RSC|RFC|RE|RRC|RWD|SC|SFC|SK|SKN|SV|SpC|TSV|UE)\s+/i', '', $this->name);
    }
