...
class Club extends Model
{
    ...
    private const string NAME_PREFIX_REGEX = '/^(III.\|1\. FC|AC|ACF|AF|AFK|AE|AJ|AK|AS|ASKÖ|BFC|CA|CD|CE|CF|CFR|CO|CS|CSM|ČFK|DSV|ÉF|EF|EFC|FBC|FC|FCI|FCM|FCV|FF|FK|GD|GFK|GNK|GS|HNK|HŠK|ÍF|IFK|IK|JFK|JK|JS|K|KAA|KF|KRC|KS|KSC|KSK|KSV|KV|KVC|LB|Le|LR|MFK|MŠK|ND|NK|NŠ|OFC|OGC|PFC|PFK|POFC|R|RAA|RC|RCS|RNK|RSC|RFC|RE|RRC|RWD|SBV|SC|SCU|SFC|SFK|SK|SKN|SL|SP|SpC|SpVgg|SpVg|SR|SS|SSC|SSD|SV|ŠK|TSV|TSG|VfB|VfR|UC|UD|UE|US|USD|USV)\s+/i';
